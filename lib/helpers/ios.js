...
var initApnSend = function initApnSend(ctx) {
    ...
    if (!ctx.apn_connection) {
        ...
        options = {
            "production": true,
            "gateway": ctx.apn.gateway,
            "key": ctx.apn.key,
            "cert": ctx.apn.certificate,
            "address": ctx.apn.address,
            "interval": 43200,
            "batchFeedback": true
        };
...
Ios.prototype.send = function(devices, data, is_silent) {
    ...
    if (iosTokens.length > 0) {
        ...
        var options = {
            ...
            image: _iconFile,
            data: _data,
            badge: typeof _data.badge !== 'undefined' ? _data.badge : null,
            sqsmessage: _data.sqsmessage || null
        };
